...
Route::middleware('auth:api')->put('/content/likeprofile/{id}', "ContentController@likeProfile");
Route::middleware('auth:api')->put('/content/commentprofile/{id}', "ContentController@commentProfile");
